...
def main():
    ...
    grid = tools.math.initialize_grid_points(args.width, args.depth, args.height, args.x, args.y, args.z)
    transformed_grid = tools.math.trans_rigide(grid, args.theta, args.omega, args.phi, args.p, args.q, args.r)
    scaled_grid = tools.math.similitude(transformed_grid, args.s)
